    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (pairedDevices.size() > 0) {
            ...
            if (!devices.contains("HC-06")) {
                Toast.makeText(getActivity(), "Not connected to HC06", Toast.LENGTH_SHORT).show();
          ...
          /*  final ArrayAdapter adapter = new ArrayAdapter(this, android.R.layout.simple_list_item_1,devices);
            ...
            Toast.makeText(getActivity(), "Please pair a device", Toast.LENGTH_SHORT).show();
            //synchronizeData.setEnabled(false);
        }
    }
    ...
    class ConnectedThread extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                ...
                /*try {
                    ...
                    Message readMsg = my_main_handler.obtainMessage(
        ...
        public void write(byte[] bytes) {
           /* try {
                ...
                Message writtenMsg = my_main_handler.obtainMessage(
                ...
                Message writeErrorMsg =
                        my_main_handler.obtainMessage(MESSAGE_TOAST);
